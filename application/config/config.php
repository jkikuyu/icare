...
function icare_error_handler($errno, $errstr, $errfile, $errline){
...
set_exception_handler("icare_exception_handler");
function icare_fatal_handler()
{
...
assert_options(ASSERT_CALLBACK, 'icare_assert_handler');
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
